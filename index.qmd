...
description: "Takshashila's Critical Minerals Desk studies the policy, technology, and geopolitics shaping India's mineral supply chains."
page-layout: full
...
<div class="cm-page">
  <section class="cm-hero" aria-labelledby="page-title">
    <div class="cm-container cm-hero__inner">
      ...
      <p>The Critical Minerals Desk studies the policy and geopolitics of the minerals that power energy systems, advanced manufacturing, and strategic technologies. We track how exploration, processing, technology, and trade shape India’s choices. Our work develops practical ideas for secure, competitive supply chains while accounting for costs, markets, and environmental constraints.</p>
    </div>
  </section>
    ...
    <section class="cm-section cm-container" id="media">
      ...
      <div class="cm-carousel" data-carousel>
        <div class="cm-card-track" data-carousel-track>
          ...
          <a class="cm-media-card cm-media-card--video" href="https://www.youtube.com/watch?v=8Fs8QXs7fo8">
            <img class="cm-media-card__thumb" src="https://i.ytimg.com/vi/8Fs8QXs7fo8/hqdefault.jpg" alt="Video thumbnail for An Explainer on Critical Minerals">
            <div class="cm-media-card__body">
              <span class="cm-card-kicker">VIDEO · ALL THINGS POLICY · 31 JUL 2025</span>
              <h3>An Explainer on Critical Minerals</h3>
              <span class="cm-card-cta">Watch <span aria-hidden="true">→</span></span>
            </div>
          </a>
        ...
        <div class="cm-carousel-controls" aria-label="Video carousel controls">
