  ...
  <main>
    ...
    <section class="cm-section cm-container" id="media">
      <div class="cm-section-heading cm-section-heading--link">
        ...
        <a href="https://legion.takshashila.org.in/all-things-policy">All Things Policy</a>
      </div>
      <div class="cm-carousel" data-carousel>
        <div class="cm-card-track" data-carousel-track>
          <a class="cm-media-card" href="https://www.youtube.com/watch?v=hOPzsR3hiR8">
            ...
            <p>Shobhankita Reddy on what India’s rare earth corridors and magnet manufacturing plans can and cannot solve.</p>
            <span class="cm-card-cta">Watch <span aria-hidden="true">→</span></span>
          </a>
          <a class="cm-media-card" href="https://podcasts.apple.com/in/podcast/india-should-double-down-on-rare-earth-recycling/id1166552728?i=1000750247855">
            <span class="cm-card-kicker">PODCAST · ALL THINGS POLICY · 18 FEB 2026</span>
            <h3>India Should Double Down on Rare Earth Recycling</h3>
            <p>Shobhankita Reddy and Tannmay Kumarr Baid discuss the practical steps behind a domestic rare earth recycling industry.</p>
            <span class="cm-card-cta">Listen <span aria-hidden="true">→</span></span>
          </a>
          <a class="cm-media-card" href="https://podcasts.apple.com/us/podcast/the-geopolitics-of-rare-earths/id1166552728?i=1000736534689">
            <span class="cm-card-kicker">PODCAST · ALL THINGS POLICY · 13 NOV 2025</span>
            <h3>The Geopolitics of Rare Earths</h3>
            <p>Manoj Kewalramani and Pranay Kotasthane on China’s leverage, strategic competition, and the future of rare earth supply chains.</p>
            <span class="cm-card-cta">Listen <span aria-hidden="true">→</span></span>
          </a>
          <a class="cm-media-card" href="https://www.mercatus.org/ideasofindia/pranay-kotasthane-political-economy-rare-earths-and-critical-minerals">
            ...
            <p>Shruti Rajagopalan speaks with Pranay Kotasthane about China’s dominance, India’s capabilities, recycling, and geopolitics.</p>
            <span class="cm-card-cta">Listen <span aria-hidden="true">→</span></span>
          </a>
          <a class="cm-media-card" href="https://stratnewsglobal.com/the-gist/worlds-manufacturing-capacity-has-hollowed-and-gone-to-china/">
            ...
            <p>Shobhankita Reddy on the India US critical minerals framework, the Quad initiative, and why capital support matters.</p>
            <span class="cm-card-cta">Watch <span aria-hidden="true">→</span></span>
          </a>
        </div>
